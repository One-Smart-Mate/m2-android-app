...
class CardActionViewModel @Inject constructor(
    ...
    private fun imagesQuantity(actionType: CardItemSheetAction, cardType: CardType?): Int {
    ...
    private fun videoQuantity(actionType: CardItemSheetAction, cardType: CardType?): Int {
        return when(actionType) {
    ...
    private fun audiosQuantity(actionType: CardItemSheetAction, cardType: CardType?): Int {
        return when(actionType) {
        ...
        viewModelScope.launch {
            ...
            when(getState().actionType) {
                ...
                CardItemSheetAction.DefinitiveSolution,
                    CardItemSheetAction.ProvisionalSolution -> handleSaveSolution()
                else -> return@launch
            }
        }
    }
//
    private fun handleOnSaveMechanic() {
        ...
        viewModelScope.launch {
            ...
            kotlin.runCatching {
                callUseCase { updateCardMechanicUseCase(
            ...
            kotlin.runCatching {
               callUseCase {
                   saveCardSolutionUseCase(
                       solutionType = if (state.actionType == CardItemSheetAction.DefinitiveSolution) DEFINITIVE_SOLUTION  else PROVISIONAL_SOLUTION,
